...
import '/sections/blog_post/blog_post_widget.dart';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'lowhmt9a' /* Grow with the Community */,
                                ),
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<BlogsRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<BlogsRecord> mobileViewBlogsRecordList =
                            snapshot.data!;
                        ...
                        return ListView.separated(
                          ...
                          itemCount: mobileViewBlogsRecordList.length,
                          separatorBuilder: (_, __) => SizedBox(height: 12.0),
                          itemBuilder: (context, mobileViewIndex) {
                            final mobileViewBlogsRecord =
                                mobileViewBlogsRecordList[mobileViewIndex];
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  16.0, 0.0, 16.0, 0.0),
                              child: Container(
                                    ...
                                    children: [
                                      Align(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            mobileViewBlogsRecord.imageUrl,
                                            width: 310.5,
                                            height: 187.4,
                                            fit: BoxFit.cover,
                                          ),
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          '${mobileViewBlogsRecord.votes.toString()} votes',
